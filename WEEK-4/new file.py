# Ine values or tne below varladies will De cnange by tne evaluator
...
a_truthy_tuple = (0,) # tuple: a tuple but when passed to bool function should return True
...
if isinstance(some_collection, (list, tuple, str, range)) : # some iterables are not reversible why?
...
if isinstance(some_collection, (list, tuple, str, range)): # some collections are not indexable why?
...
if isinstance(some_collection, (list, tuple, str, range)): # some collections are not slicable
...
if isinstance(some_collection, (list, tuple, str, range)): # some collections are not ordered
